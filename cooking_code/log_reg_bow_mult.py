...
train_set_c, test_set_c = cooking_util.clean_data_bow_mult(train_set, test_set)
...
print "writing submission file to sub_log_mult.csv"
cooking_util.submit(clf.predict, test_set_c, dm, filename='sub_log_mult.csv')
print "finished"